...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
			...
			this.element
				...
				.on("dblclick.jstree", ".jstree-anchor", $.proxy(function (e) {
						...
						if(this.settings.core.dblclick_toggle) {
							this.toggle_node(e.target);
							this.dblclick_node(e.currentTarget,e);
						}
					}, this))
		...
		dblclick_node:function (obj,  e){
			this.trigger('dblclick_node', { 'node' : this.get_node(obj), 'selected' : this.get_node(obj).id, 'event' : e });
		},
		/**
		 * deselect a node
