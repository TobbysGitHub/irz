package com.imfbp.rz.domain.rzprjreviewguar;
...
public class RzPrjreviewGuar  implements Serializable{
	...
	private RzPrjreviewGuarB[] rzPrjreviewGuarBArray;
	
	public RzPrjreviewGuarB[] getRzPrjreviewGuarBArray() {
		return rzPrjreviewGuarBArray;
	}

	public void setRzPrjreviewGuarBArray(RzPrjreviewGuarB[] rzPrjreviewGuarBArray) {
		this.rzPrjreviewGuarBArray = rzPrjreviewGuarBArray;
	}
