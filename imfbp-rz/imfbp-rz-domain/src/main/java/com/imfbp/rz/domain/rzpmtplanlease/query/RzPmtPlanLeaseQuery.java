package com.imfbp.rz.domain.rzpmtplanlease.query;

import java.io.Serializable;
import com.platform.common.utils.query.BaseQuery;

public class RzPmtPlanLeaseQuery extends BaseQuery implements Serializable{

	private static final long serialVersionUID = 1L;

	//主键
	private String pkPmtPlanLease;
	//主键
	...
	public void setPkPmtPlanLease(String pkPmtPlanLease){
		this.pkPmtPlanLease =  pkPmtPlanLease;
	}
	
	public String getPkPmtPlanLease(){
		return pkPmtPlanLease;
	}
