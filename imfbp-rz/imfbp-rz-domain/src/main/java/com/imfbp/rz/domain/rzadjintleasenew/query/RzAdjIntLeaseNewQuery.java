package com.imfbp.rz.domain.rzadjintleasenew.query;

import java.io.Serializable;
import com.platform.common.utils.query.BaseQuery;

public class RzAdjIntLeaseNewQuery extends BaseQuery implements Serializable{

	private static final long serialVersionUID = 1L;

	//主键
	private String pkAdjIntLeaseNew;
	//主键
	...
	public void setPkAdjIntLeaseNew(String pkAdjIntLeaseNew){
		this.pkAdjIntLeaseNew =  pkAdjIntLeaseNew;
	}
	
	public String getPkAdjIntLeaseNew(){
		return pkAdjIntLeaseNew;
	}
