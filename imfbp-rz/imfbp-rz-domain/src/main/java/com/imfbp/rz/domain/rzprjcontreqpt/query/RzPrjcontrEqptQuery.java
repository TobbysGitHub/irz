package com.imfbp.rz.domain.rzprjcontreqpt.query;

import java.io.Serializable;
import com.platform.common.utils.query.BaseQuery;

public class RzPrjcontrEqptQuery extends BaseQuery implements Serializable{

	private static final long serialVersionUID = 1L;

	//主键
	private String pkPrjcontrEqpt;
	//立项申请主键
	...
	public void setPkPrjcontrEqpt(String pkPrjcontrEqpt){
		this.pkPrjcontrEqpt =  pkPrjcontrEqpt;
	}
	
	public String getPkPrjcontrEqpt(){
		return pkPrjcontrEqpt;
	}
