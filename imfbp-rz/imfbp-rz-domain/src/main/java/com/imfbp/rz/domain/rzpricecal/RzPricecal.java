package com.imfbp.rz.domain.rzpricecal;


import java.io.Serializable;

public class RzPricecal  implements Serializable{
    ...
    private String isPlanChan;
    
    private Integer oriLeaseprd;
	...
	public String getIsPlanChan() {
		return isPlanChan;
	}

	public void setIsPlanChan(String isPlanChan) {
		this.isPlanChan = isPlanChan;
	}

	public Integer getOriLeaseprd() {
		return oriLeaseprd;
	}

	public void setOriLeaseprd(	Integer oriLeaseprd) {
		this.oriLeaseprd = oriLeaseprd;
	}
