package com.imfbp.rz.domain.rzprjcontrchgeqpt.query;

import java.io.Serializable;
import com.platform.common.utils.query.BaseQuery;

public class RzPrjcontrChgEqptQuery extends BaseQuery implements Serializable{

	private static final long serialVersionUID = 1L;

	//主键
	private String pkPrjcontrChgEqpt;
	//立项申请主键
	...
	public void setPkPrjcontrChgEqpt(String pkPrjcontrChgEqpt){
		this.pkPrjcontrChgEqpt =  pkPrjcontrChgEqpt;
	}
	
	public String getPkPrjcontrChgEqpt(){
		return pkPrjcontrChgEqpt;
	}
