package com.imfbp.rz.domain.rzprjapplyeqpt.query;

import java.io.Serializable;
import com.platform.common.utils.query.BaseQuery;

public class RzPrjapplyEqptQuery extends BaseQuery implements Serializable{

	private static final long serialVersionUID = 1L;

	//主键
	private String pkPrjapplyEqpt;
	//立项申请主键
	...
	public void setPkPrjapplyEqpt(String pkPrjapplyEqpt){
		this.pkPrjapplyEqpt =  pkPrjapplyEqpt;
	}
	
	public String getPkPrjapplyEqpt(){
		return pkPrjapplyEqpt;
	}
